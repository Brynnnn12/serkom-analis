<x-layouts.dashboard title="Tambah Pelanggan - Admin" guard="web" sidebarActive="pelanggans">
        ...
        <form action="{{ route('pelanggans.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_pelanggan" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nomor_kwh" name="nomor_kwh" value="{{ old('nomor_kwh') }}" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
                    @error('nomor_kwh')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4 md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-between mt-6">
                ...
                <x-button href="{{ route('pelanggans.index') }}" class="bg-gray-600 hover:bg-gray-700">Batal</x-button>
            </div>
        </form>
    </x-card>
</x-layouts.dashboard>
