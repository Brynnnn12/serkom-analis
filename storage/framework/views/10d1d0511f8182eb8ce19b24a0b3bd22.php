...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Kelola Pembayaran - '.e($isAdmin ? 'Admin' : 'Pelanggan').'','guard' => ''.e($isAdmin ? 'web' : 'pelanggan').'','sidebarActive' => 'pembayarans']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kelola Pembayaran - '.e($isAdmin ? 'Admin' : 'Pelanggan').'','guard' => ''.e($isAdmin ? 'web' : 'pelanggan').'','sidebarActive' => 'pembayarans']); ?>
    <div class="p-6 bg-white rounded-lg shadow-md mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Riwayat Pembayaran</h2>
        <p class="text-gray-600 mt-2"><?php echo e($isAdmin ? 'Pantau pembayaran pelanggan' : 'Riwayat pembayaran Anda'); ?></p>
    </div>
...
<?php $component->withAttributes(['class' => 'bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow']); ?>
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?php echo e($pembayarans->count()); ?></p>
                    </div>
                </div>
...
<?php $component->withAttributes(['class' => 'bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow']); ?>
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold">Rp <?php echo e(number_format($pembayarans->sum('total_bayar'), 0, ',', '.')); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal53747ceb358d30c0105769f8471417f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal53747ceb358d30c0105769f8471417f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.card','data' => ['class' => 'bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow']); ?>
                <div class="flex items-center">
                    <div class="shrink-0">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm"><?php echo e($pembayarans->first() ? \Carbon\Carbon::parse($pembayarans->first()->tanggal_pembayaran)->format('d/m/Y') : 'Belum ada'); ?></p>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="border-b hover:bg-gray-50 bg-green-50">
                            <?php if($isAdmin): ?>
                                <td class="px-6 py-4 border border-gray-300"><?php echo e($pembayaran->tagihan->pelanggan->nama_pelanggan ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 border border-gray-300"><?php echo e($pembayaran->user->nama_admin ?? 'N/A'); ?></td>
                            <?php endif; ?>
                            <td class="px-6 py-4 border border-gray-300">
                                <div class="font-medium"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal_pembayaran)->format('d/m/Y')); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e(\Carbon\Carbon::parse($pembayaran->tanggal_pembayaran)->format('H:i')); ?></div>
                            </td>
                            <td class="px-6 py-4 border border-gray-300">
                                <div class="font-medium"><?php echo e(date('F', mktime(0, 0, 0, $pembayaran->bulan_bayar, 1))); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($pembayaran->tahun_bayar); ?></div>
                            </td>
                            <td class="px-6 py-4 border border-gray-300">
                                <div class="font-semibold text-green-600">Rp <?php echo e(number_format($pembayaran->total_bayar, 0, ',', '.')); ?></div>
                            </td>
                            <td class="px-6 py-4 border border-gray-300">
...
<?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e($isAdmin ? 6 : 4); ?>" class="px-6 py-8 text-center text-gray-500 border border-gray-300">
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/pembayarans/index.blade.php ENDPATH**/ ?>