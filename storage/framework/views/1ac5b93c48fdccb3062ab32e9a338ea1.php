...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Detail Pelanggan - Admin','guard' => 'web','sidebarActive' => 'pelanggans']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Pelanggan - Admin','guard' => 'web','sidebarActive' => 'pelanggans']); ?>
...
<?php $component->withAttributes(['class' => 'p-6 bg-white rounded-lg shadow-md']); ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="mb-4">
                ...
                <p class="text-gray-900"><?php echo e($pelanggan->id_pelanggan); ?></p>
            </div>
            <div class="mb-4">
                <strong class="block text-gray-700 text-sm font-bold mb-2">Nomor KWH:</strong>
                <p class="text-gray-900"><?php echo e($pelanggan->nomor_kwh); ?></p>
            </div>
            <div class="mb-4">
                <strong class="block text-gray-700 text-sm font-bold mb-2">Nama Pelanggan:</strong>
                <p class="text-gray-900"><?php echo e($pelanggan->nama_pelanggan); ?></p>
            </div>
            <div class="mb-4">
                <strong class="block text-gray-700 text-sm font-bold mb-2">Username:</strong>
                <p class="text-gray-900"><?php echo e($pelanggan->username); ?></p>
            </div>
            <div class="mb-4 md:col-span-2">
                <strong class="block text-gray-700 text-sm font-bold mb-2">Alamat:</strong>
                <p class="text-gray-900"><?php echo e($pelanggan->alamat); ?></p>
            </div>
            <div class="mb-4">
                <strong class="block text-gray-700 text-sm font-bold mb-2">Tarif:</strong>
                <p class="text-gray-900"><?php echo e($pelanggan->tarif->daya); ?> VA - Rp <?php echo e(number_format($pelanggan->tarif->tarifperkwh)); ?></p>
            </div>
        </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pelanggans.index')).'','class' => 'bg-gray-600 hover:bg-gray-700']); ?>Kembali <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['href' => ''.e(route('pelanggans.edit', $pelanggan->id_pelanggan)).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('pelanggans.edit', $pelanggan->id_pelanggan)).'']); ?>Edit <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561)): ?>
<?php $attributes = $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561; ?>
<?php unset($__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561); ?>
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/pelanggans/show.blade.php ENDPATH**/ ?>