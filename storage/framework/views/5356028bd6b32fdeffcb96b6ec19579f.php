...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Edit Pelanggan - Admin','guard' => 'web','sidebarActive' => 'pelanggans']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Pelanggan - Admin','guard' => 'web','sidebarActive' => 'pelanggans']); ?>
...
<?php $component->withAttributes(['class' => 'p-6 bg-white rounded-lg shadow-md']); ?>
        <form action="<?php echo e(route('pelanggans.update', $pelanggan)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    <label for="nama_pelanggan" class="block text-gray-700 text-sm font-bold mb-2">Nama Pelanggan</label>
                    <input type="text" id="nama_pelanggan" name="nama_pelanggan" value="<?php echo e(old('nama_pelanggan', $pelanggan->nama_pelanggan)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nomor_kwh" name="nomor_kwh" value="<?php echo e(old('nomor_kwh', $pelanggan->nomor_kwh)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <textarea id="alamat" name="alamat" rows="3" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required><?php echo e(old('alamat', $pelanggan->alamat)); ?></textarea>
                ...
                <div class="mb-4">
                    ...
                    <select id="id_tarif" name="id_tarif" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <?php $__currentLoopData = $tarifs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tarif->id_tarif); ?>" <?php echo e(old('id_tarif', $pelanggan->id_tarif) == $tarif->id_tarif ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" value="<?php echo e(old('username', $pelanggan->username)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/pelanggans/edit.blade.php ENDPATH**/ ?>