    ...
    <div class="container">
        ...
        <div class="buttons">
            <?php if(Route::has('login')): ?>
                <a href="<?php echo e(route('login')); ?>" class="btn">Login sebagai Admin/Petugas</a>
                <a href="<?php echo e(route('pelanggan.login.form')); ?>" class="btn btn-admin">Login sebagai Pelanggan</a>
            <?php endif; ?>
        </div>
...
<?php /**PATH D:\Serkom-2\serkom\resources\views/welcome.blade.php ENDPATH**/ ?>