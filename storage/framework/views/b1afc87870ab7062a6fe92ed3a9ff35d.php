...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Edit Admin - Admin','guard' => 'web','sidebarActive' => 'users']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Admin - Admin','guard' => 'web','sidebarActive' => 'users']); ?>
        ...
        <form action="<?php echo e(route('users.update', $user)); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-4">
                    ...
                    <input type="text" id="nama_admin" name="nama_admin" value="<?php echo e(old('nama_admin', $user->nama_admin)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" value="<?php echo e(old('username', $user->username)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
                ...
                <div class="mb-4">
                    ...
                    <select id="id_level" name="id_level" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level->id_level); ?>" <?php echo e(old('id_level', $user->id_level) == $level->id_level ? 'selected' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/users/edit.blade.php ENDPATH**/ ?>