...
<?php $component = App\View\Components\Layouts\App::resolve(['title' => 'Login - PLN Bayar Listrik'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="max-w-md w-full bg-white rounded-xl shadow-2xl p-8 mx-4">
            ...
            <form action="<?php echo e(route('login')); ?>" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="username" name="username" value="<?php echo e(old('username')); ?>" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200" placeholder="Masukkan username" required>
                </div>
                <div class="mb-6">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['type' => 'submit','class' => 'w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-200']); ?>Masuk <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/auth/login.blade.php ENDPATH**/ ?>