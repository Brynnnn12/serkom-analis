...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.dashboard','data' => ['title' => 'Edit Tarif - Admin','guard' => 'web','sidebarActive' => 'tarifs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Tarif - Admin','guard' => 'web','sidebarActive' => 'tarifs']); ?>
...
<?php $component->withAttributes(['class' => 'p-6 bg-white rounded-lg shadow-md']); ?>
        <form action="<?php echo e(route('tarifs.update', $tarif)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="mb-4">
                <label for="daya" class="block text-gray-700 text-sm font-bold mb-2">Daya</label>
                <input type="text" id="daya" name="daya" value="<?php echo e(old('daya', $tarif->daya)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" id="tarifperkwh" name="tarifperkwh" value="<?php echo e(old('tarifperkwh', $tarif->tarifperkwh)); ?>" class="shadow appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-blue-500" required>
...
<?php endif; ?>
<?php /**PATH D:\Serkom-2\serkom\resources\views/tarifs/edit.blade.php ENDPATH**/ ?>